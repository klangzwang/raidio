...
class PresetManager {
    ...
    public static createVoicePresets(): VoicePreset[] {
        this.presets = [
            ...
            { presetId: "robot", label: "Roboter", pitchEffectChain: { pitch: 0, gain: 1.0, distortion: 0.8, reverb: 0.2, echo: 0.1 } },

            // --- Tactical & Sci-Fi Vibes ---
            { presetId: "radio_comms", label: "Taktischer Funk", pitchEffectChain: { pitch: 0, gain: 0.8, distortion: 0.5, reverb: 0.1, echo: 0 } },
            ...
            { presetId: "megaphone", label: "Megafon", pitchEffectChain: { pitch: 0, gain: 1.5, distortion: 0.6, reverb: 0.2, echo: 0.1 } },
            { presetId: "overdrive", label: "Maximum Overdrive", pitchEffectChain: { pitch: 0, gain: 2.0, distortion: 1.0, reverb: 0.5, echo: 0 } }
        ];
        return this.presets;
    }
}
